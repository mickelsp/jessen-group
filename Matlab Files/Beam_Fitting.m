...
%% Initialization
fontsize = 16;
lambda = 894e-9; %[m] wavelength of the laser beam
...
inputfilename = char('ProbeLaser_FiberLink_ReverseOutput_20131008.txt');
...
InitialGuess=[1e-4 1]; %[m m] initial guess for waist value and position of waist

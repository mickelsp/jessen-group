...
%%% all file names.
directory=char('/Users/Work/Documents/Free Space Coupling/Data/2012.01.11/');
imagefilename=char('AF_test_target_02MOD.bmp');
...
elseif fullroi==0
    if variableROI==0
        ...
        roirowstart=365;   %Starting row for region of interest (min = 1)
        roirowstop=380;    %Ending row for region of interest (max = 494)
        roicolstart=215;   %Starting column for region of interest (min = 1)
        roicolstop=230;    %Ending column for region of interest (max = 656)

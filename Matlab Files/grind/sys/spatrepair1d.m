function spatrepair1d(err, distloc, refloc, disturbfunc, par, p_start, p_end, npoints)
global g_grind;
...
if ~((nargin==1) && (i_checkstr(err)==-1))
   if nargin < 8
      ...
      distloc = str2num(answer{2}); %#ok
      refloc = str2num(answer{3}); %#ok
